...
try {
    ...
    LEFT JOIN (
        ...
        $stmt = $conn->prepare(" /*SELECT distinct TO_CHAR(a.fllegada, 'YYYYMM') as periodo, count(*) casos
                                FROM  embarquesmm a where TO_CHAR(a.fllegada, 'YYYYMM') <='202411'
                                GROUP BY TO_CHAR(a.fllegada, 'YYYYMM')
                                union*/
                                SELECT distinct TO_CHAR(a.fllegada, 'YYYYMM') as periodo, count(*) casos
