        ...
        <div class="card border-danger ">
            <div class="card-header bg-danger text-white border-danger ">Registro Embarque</div>
                <div class="card-body" >
                    <div class="row">
                    <div class="col-md-6">
                            <label for="inputState" class="form-label form-control-sm text-danger">VENDEDOR:</label>
                            <select id="listven" name="vendedores[]" class="form-select form-select-sm text-uppercase">
                            <option selected> </option>    
                            <?php foreach ($vendedores as $vendedor) {  ?>
                                    <option  style="text-transform:uppercase" <?php
                                            if (!empty($listven)) {
                                                    if (in_array($vendedor['trabajador'],$vendedores)) {
                                                    echo 'selected';
                                                    }
                                            }
                                            ?>
									value="<?php echo $vendedor['us_email']; ?>" ><?php echo $vendedor['trabajador']; ?>
							        </option>  
							    <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                        <label for="inputState" class="form-label form-control-sm text-danger">SUCURSAL:</label>
                            <select id="listasuc" name="sucursales[]" class="form-select form-select-sm text-uppercase">
                            <option selected> </option>    
                            <?php foreach ($sucursales as $sucursal) {  ?>
                                    <option  style="text-transform:uppercase" <?php
                                            if (!empty($listasuc)) {
                                                    if (in_array($sucursal['sucursal'],$sucursales)) {
                                                    echo 'selected';
                                                    }
                                            }
                                            ?>
									value="<?php echo $sucursal['id']; ?>" ><?php echo $sucursal['sucursal']; ?>
							        </option>  
							    <?php } ?>
                            </select>
                        </div>
